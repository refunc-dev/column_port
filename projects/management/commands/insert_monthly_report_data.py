...
from projects.models import Project, Regex, MonthlyAll, MonthlyDir
from projects.management.commands.utils.get_all_analytics_data import get_monthly_analytics_data
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for p in projects:
            data = get_monthly_analytics_data()
            for d in data:
